  ...
  function triggerBotAttention() {
    ...
    setTimeout(function () {
      ...
      if (bubble) {
        ...
        bubble.style.background = 'rgba(168,132,44,0.9)';
        bubble.style.color = '#fff';
        bubble.style.borderColor = 'rgba(212,175,106,0.8)';
        bubble.style.boxShadow = '0 0 20px rgba(168,132,44,0.5)';
        setTimeout(function () {
