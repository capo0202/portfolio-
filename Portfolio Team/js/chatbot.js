(function () {
  ...
  var EMAILJS_SERVICE_ID  = 'service_69u7qus';
  var EMAILJS_TEMPLATE_ID = 'template_x620wqj';
  var EMAILJS_PUBLIC_KEY  = 'j9bH5ncToJQtVa4bc';
  ...
  function triggerBotAttention() {
    ...
    setTimeout(function () {
      ...
      if (bubble) {
        ...
        bubble.style.background = 'rgba(201,161,74,0.9)';
        bubble.style.color = '#fff';
        bubble.style.borderColor = 'rgba(224,196,120,0.8)';
        bubble.style.boxShadow = '0 0 20px rgba(201,161,74,0.5)';
        setTimeout(function () {
